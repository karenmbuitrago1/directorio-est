...
var getZoomMap = d3.scale
  .linear()
  .range([18, 0])
  .domain([0, $('.ActionBar__list__item__scrollBar').height()]);
...
$('.searchBox__input').on('keyup', function (event) {
  ...
  $('.functionFilter__container__selectListbox__selectList__item').filter(
    function () {
...
function loadDivipola() {
  urlDivipola =
    'https://geoportal.dane.gov.co/laboratorio/serviciosjson/cnpv/divipola.php';
  $.ajax({
    url: urlDivipola,
    type: 'GET',
    success: function (data) {
      if (data.resultado.length > 0) {
        ...
        $('<option value="-1">Todos los departamentos</option>').appendTo(
          $('#FiltroGeograficoLvl1')
        );
        ...
        for (var i = 0; i < data.resultado.length; i++) {
          $(
            '<option value="' +
              data.resultado[i]['U_DPTO'] +
              '">' +
              data.resultado[i]['U_DPTO'] +
              ' - ' +
              data.resultado[i]['NOM_DPTO'].toUpperCase() +
              '</option>'
          ).appendTo($('#FiltroGeograficoLvl1'));
          listaDivipolaDeptos.push([
            data.resultado[i]['U_DPTO'],
            data.resultado[i]['NOM_DPTO'].toUpperCase(),
          ]);
        }
          ...
          $.ajax({
            ...
            success: function (dataTres) {
              ...
              if (dataTres.length > 0) {
                ...
                for (var i = 0; i < dataTres.length; i++) {
                  if (dataTres[i]['NIVELES_FILTRO'] == '0') {
                    listaFilterVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['CAMPO_TABLA'],
                    ]);
                    listaVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['CAMPO_TABLA'],
                    ...
                    listaFilterVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['CAMPO_DOMINIO'],
                    ]);
                    listaVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['VALOR_DOMINIO'],
                    ]);
                  } else if (dataTres[i]['NIVELES_FILTRO'] == '2') {
                    listaFilterVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['CAMPO_DOMINIO2'],
                    ]);
                    listaVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['VALOR_DOMINIO2'],
                    ]);
                  } else if (dataTres[i]['NIVELES_FILTRO'] == '3') {
                    listaFilterVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['CAMPO_DOMINIO3'],
                    ]);
                    listaVariables.push([
                      dataTres[i]['COD_CATEGORIA'],
                      dataTres[i]['VALOR_DOMINIO3'],
                    ]);
                  }
                  listaNivelesFiltro.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['NIVELES_FILTRO'],
                  ]);
                  listaNombresVariables.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['CATEGORIA'],
                  ]);
                  listaVisualizacion.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['GRAFICO_ESTADISTICO'],
                  ]);
                  listaColores.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['COLOR'].replace('(', '').replace(')', ''),
                  ]);
                  listaUnidades.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['UNIDAD'],
                  ...
                  listaClaseTiene.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['FILTRO_CLASE'],
                  ]);
                  listaSexo.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['FILTRO_SEXO'],
                  ]);
                  listaAnioTiene.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['FILTRO_TIEMPO'],
                  ]);

                  listaCompuestoTiene.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['VISUAL_AGRUPADO'],
                  ]);
                  listaTipo.push([
                    dataTres[i]['COD_CATEGORIA'],
                    dataTres[i]['TIPO_VARIABLE'],
                  ]);
                }
              }
              ...
              setTimeout(function () {
                if (
                  urlGet.search != '' &&
                  urlGet.searchParams.get('t') != null &&
                  urlGet.searchParams.get('s') != null &&
                  urlGet.searchParams.get('v') != null
                ) {
                ...
                var title = $(
                  '.functionFilter__thematic__item.' +
                    $var.Map.varVariable.substring(0, 5) +
                ...
                var nameVar = $(
                  '.functionFilter__thematicVariable__item.--active'
                ).text();

                $('.map__name__subtitle').text(
                  title + ' - ' + subtitle + ' - ' + nameVar
                );
                $('.functionFilter__description__title').text(
                  title + ' - ' + subtitle + ' - ' + nameVar
                );
                $('.results__panel__title__themeName').text(
                  title + ' - ' + subtitle + ' - ' + nameVar
                );
                $('.Geovisor__tableBox__top__tableName').text(
                  'Tabla de datos' +
                    ' - ' +
                    $('.results__panel__title__themeName').text()
                );
...
function listaTematica(cod_grupo, cod_subGrupo, dataTres) {
  ...
  $.each(cod_grupo, function (key, value) {
    ...
    count++;
    var listaGrupo = $('<li/>', {
      id: value[0]['COD_GRUPO'],
      class: 'functionFilter__thematicGroup__item ' + value[0]['COD_GRUPO'],
    });
    let cajaGrupo = $('<div/>', {
      class: 'functionFilter__thematicGroup__icon ' + value[0]['CLASE_COLOR'],
    });
    $('<span/>', { class: value[0]['CLASE_ICONO'] }).appendTo(cajaGrupo);
    cajaGrupo.appendTo(listaGrupo);
    $('<p/>', {
      class: 'functionFilter__thematicGroup__name',
      text: ' ' + value[0]['GRUPO'],
    }).appendTo(listaGrupo);
  ...
  $.each(cod_subGrupo, function (key, value) {
    //para la herramienta de filtros en el panel Toolbar
    var listaGrupo = $('<li/>', {
      id: value[0]['COD_SUBGRUPO'],
      class: 'functionFilter__thematic__item ' + value[0]['COD_SUBGRUPO'],
    });
    var listaVariable = $('<ul/>', {
      id: value[0]['COD_SUBGRUPO'],
      class:
        'functionFilter__thematicVariable__list ' + value[0]['COD_SUBGRUPO'],
    });
    $('<h3/>', {
      class: 'functionFilter__thematic__name',
      text: ' ' + value[0]['SUBGRUPO'],
    }).appendTo(listaGrupo);
    ...
    var grupoLista = $(
      '.functionFilter__thematicGroup__item.' + thecode + ' '
    ).text();
    var newP = $('<p/>', {
      class: 'functionFilter__thematic__nameGroup',
      text: ' ' + grupoLista,
    });
    newP.insertBefore(
      $(
        '.functionFilter__thematic__item#' +
          value[0]['COD_SUBGRUPO'] +
          ' .functionFilter__thematic__name'
      )
    );
  });
  ...
  myData.map(function (obj, j, k) {
    ...
    //para la herramienta de filtros en el panel Toolbar
    var listaTemp = $('<li/>', {
      id: obj['COD_CATEGORIA'],
      class: 'functionFilter__thematicVariable__item ' + obj['COD_CATEGORIA'],
      title: obj['grupo'][0]['GRUPO'] + ' - ' + obj['SUBGRUPO'],
    });
    let cajaUno = $('<div/>', {
      class: 'functionFilter__thematicVariable__radio',
    });
    $('<span/>', { class: 'DANE__Geovisor__icon__radioButton' }).appendTo(
      cajaUno
    );
    let cajaDos = $('<p/>', {
      class: 'functionFilter__thematicVariable__value',
      text: ' ' + obj['CATEGORIA'],
    });
    let cajaTres = $('<div/>', {
      class: 'functionFilter__thematicVariable__icon ',
      style: 'background:rgba' + obj['COLOR'],
    });
    ...
    listaTemp.appendTo(
      $('.functionFilter__thematicVariable__list.' + subGrupo)
    );
  }, []);
  ...
  $('.functionFilter__thematicVariable__item').click(function (e) {
    ...
    $('.Geovisor__tableBox__top__tableName').text(
      'Tabla de datos' + ' - ' + $('.results__panel__title__themeName').text()
    );
...
$var.Map.loadTemas = function () {
  urlTemas =
    'https://geoportal.dane.gov.co/laboratorio/serviciosjson/visores/temas.php' +
    '?codigo=' +
    $var.Map.codigoVisor +
    '&sub_temas=' +
    'yes';
      ...
      if (data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          if (
            data[i]['COD_GRUPO'] ==
            $(
              '.functionFilter__container__selectListbox__selectList__item.--active'
            ).attr('id')
          ) {
            if (!firstTematica) {
              $(
                '<li class="functionFilter__container__selectListbox__selectList__item level__2 --active " id="' +
                  data[i]['COD_SUBGRUPO'] +
                  '"><div class="functionFilter__accordion__panel__theme__btn --nameSubtema"><div class="functionFilter__accordion__panel__theme__btn__radio"><span class="DANE__Geovisor__icon__radioButton"></span></div><p class="functionFilter__accordion__panel__theme__btn__name">' +
                  data[i]['SUBGRUPO'] +
                  '</p></div><div class="functionFilter__container__selectListbox --tab02"><ul class="functionFilter__container__selectListbox__selectList --variables-tematicas ' +
                  data[i]['COD_SUBGRUPO'] +
                  '"></ul></div></li>'
              ).appendTo($('.--subtemas-tematicas.' + data[i]['COD_GRUPO']));
              firstTematica = true;
              $('.functionFilter__description__text').text(
                data[i]['DESCRIPCION_SUBGRUPO']
              );
            } else {
              $(
                '<li class="functionFilter__container__selectListbox__selectList__item level__2" id="' +
                  data[i]['COD_SUBGRUPO'] +
                  '"><div class="functionFilter__accordion__panel__theme__btn --nameSubtema"><div class="functionFilter__accordion__panel__theme__btn__radio"><span class="DANE__Geovisor__icon__radioButton"></span></div><p class="functionFilter__accordion__panel__theme__btn__name">' +
                  data[i]['SUBGRUPO'] +
                  '</p></div><div class="functionFilter__container__selectListbox --tab02"><ul class="functionFilter__container__selectListbox__selectList --variables-tematicas ' +
        ...
        $('.map__name__subtitle').text(
          $('.--subtemas-tematicas > .--active .--nameSubtema').text()
        );
        $('.results__panel__title__themeName').text(
          $('.--subtemas-tematicas > .--active.level__2 .--nameSubtema').text()
        );
        $('.functionFilter__description__title').text(
          $('.--subtemas-tematicas > .--active.level__2 .--nameSubtema').text()
        );
...
function loadEstadisticas(
  ...
  var url =
    'https://geoportal.dane.gov.co/laboratorio/serviciosjson/visores/variables.php' +
    '?codigo_subgrupo=' +
    subtema;
...
function reloadEstadisticas(
  ...
  var urlEmpresas =
    'https://geoportal.dane.gov.co/laboratorio/serviciosjson/directoriodeempresas/coordenadas1.php';

  if (FiltroGeograficoLvl2 && FiltroGeograficoLvl2 != -1) {
    urlEmpresas +=
      '?cod_dpto=' + FiltroGeograficoLvl1 + '&cod_mpio=' + FiltroGeograficoLvl2;
  }
  ...
  if (getTipoDiv() == 'VC' || getTipoDiv() == 'C') {
    ...
    $('#results_entidad .functionFilter__accordion__btn__name').text(
      'Distribución de las Empresas'
    ); //Participación ente territorial
    ...
    $('#results_entidad .functionFilter__accordion__btn__name').text(
      'Participación de la entidad territorial'
    );
    ...
    $('#results_entidad').next().addClass('--open');
    $('#results_entidad .functionFilter__accordion__btn__name').text(
      'Índices por entidad territorial'
    );
  }
...
function loadDataDirectorio() {
  var urltotal =
    'https://geoportal.dane.gov.co/laboratorio/serviciosjson/directoriodeempresas/conteociiu.php';
    ...
    success: function (data__total) {
      ...
      for (var i = 0; i < data__total.length; i++) {
        if (data__total[i]['TOTAL']) {
          ...
          $(
            '<li class="results__panel__total__data__actividades">' +
              parseFloat(data__total[i]['TOTAL']).toLocaleString('de-De') +
              '</div>'
          ).appendTo('.results__panel__total__data__actividades');
        }
      }
      ...
      for (var i = 0; i < data__total.length; i++) {
        if (data__total[i]['TOTAL_EMPRESAS']) {
          ...
          $(
            '<div class="results__panel__total__data__empresas">' +
              parseFloat(data__total[i]['TOTAL_EMPRESAS']).toLocaleString(
                'de-De'
              ) +
              '</div>'
          ).appendTo('.results__panel__total__data__empresas');
        }
      }
    },
  });
...
function loadPie(data) {
        ...
        if (
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              ...
              dataPiePorcentajes[j] += parseFloat(
                getNumber(data[i][variablesArreglo[j]])
              );
              totalPie += parseFloat(getNumber(data[i][variablesArreglo[j]]));
            } else {
              if (data[i]['CLASE'] == getClase()) {
                dataPie[j] += parseFloat(
                  getNumber(data[i][variablesArreglo[j]])
                );
                dataPiePorcentajes[j] += parseFloat(
                  getNumber(data[i][variablesArreglo[j]])
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              if (data[i]['CODIGO_F2'].length == 3) {
                if (
                  data[i]['CODIGO_F1'] + data[i]['CODIGO_F2'] ==
                  $('#FiltroGeograficoLvl2').val()
                ) {
                  dataPie[j] += parseFloat(
                    getNumber(data[i][variablesArreglo[j]])
              ...
              if (data[i]['CLASE'] == getClase()) {
                if (data[i]['CODIGO_F2'].length == 3) {
                  ...
                  if (
                    data[i]['CODIGO_F2'] == $('#FiltroGeograficoLvl2').val()
                  ) {
                    dataPie[j] += parseFloat(
                      getNumber(data[i][variablesArreglo[j]])
                    );
        ...
        if (
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              if (data[i]['CODIGO_F2'].length == 3) {
                if (
                  data[i][variablesFiltroArreglo[j]] == variablesArreglo[j] &&
                  data[i]['CODIGO_F1'] + data[i]['CODIGO_F2'] ==
                    $('#FiltroGeograficoLvl2').val()
                ) {
                  dataPie[j] += parseFloat(getNumber(data[i]['VALOR']));
  ...
  g.append('path')
    ...
    .on('mousemove', function (d, i) {
      ...
      div
        .append('text')
        .html(
          variablesNombreArreglo[i] +
            ': ' +
            d.data.toLocaleString('de-De') +
            ' ' +
            getUnidades($var.Map.varVariable) +
            ' (' +
            parseFloat(dataPiePorcentajes[i].toFixed(1)).toLocaleString(
              'de-De'
            ) +
            '%)'
        );
  ...
  g.append('text')
    ...
    .text(function (d, i) {
      if (dataPiePorcentajes[i] > 5) {
        return (
          parseFloat(dataPiePorcentajes[i].toFixed(1)).toLocaleString('de-De') +
          '%'
        );
      }
    });
  ...
  g.append('polyline').attr('points', function (d, i) {
    if (dataPiePorcentajes[i] > 5) {
      var pos = outerArc.centroid(d);
  ...
  svg
    ...
    .text(
      'Total: ' +
        totalPie.toLocaleString('de-DE') +
        ' ' +
        getUnidades(varVariable)
    );
  ...
  var grapho = svgPrint
    ...
    .attr(
      'transform',
      'translate(' + widthPrint / 2 + ',' + (radiusPrint + 30) + ')'
    );
  ...
  var u = svgPrint.selectAll('path').data(piePrint(dataPie));
  ...
  var legend = svgPrint
    ...
    .attr(
      'transform',
      'translate(' + widthPrint / 2 + ',' + (radiusPrint * 2 + 60) + ')'
    )
    .attr('class', 'legend');
...
function loadDonaClase(data) {
  ...
  if (variablesArreglo.length == 0) {
    ...
    if (getTipoDiv() == 'VA') {
            ...
            if (data[i]['CODIGO_F1'] == dataEntidades[k]) {
              for (var j = 0; j < variablesArreglo.length; j++) {
                if (data[i]['CLASE'] == variablesArreglo[j][0]) {
                  if (getNivelesFiltro() == '0') {
                    dataArray[k][1][j] += parseFloat(
                      getNumber(data[i][variableSeleccion])
                    );
                    dataArrayPorcentajes.push(
                      parseFloat(getNumber(data[i][variableSeleccion]))
                    );
                  } else {
                    dataArray[k][1][j] += parseFloat(
                      getNumber(data[i]['VALOR'])
                    ...
                    dataArrayPorcentajes.push(
                      parseFloat(getNumber(data[i]['VALOR']))
                    );
                  }
                }
              }
      ...
      if ($('.results__panel__dona').width() == 0) {
        var width =
          $('.Geovisor__content').width() * 0.2 -
          20 -
          margin.left -
          margin.right;
      } else {
        var width =
          $('.results__panel__dona').width() - margin.left - margin.right;
      }

      var max =
        d3.max(dataArrayPorcentajes) + d3.max(dataArrayPorcentajes) * 0.1;

      var y0 = d3.scale.ordinal().rangeRoundBands([heightBarras, 0], 0.1);
      ...
      y1.domain(
        variablesArreglo.map(function (d, i) {
          return i;
        })
      ...
      var legend = svg
        ...
        .attr(
          'transform',
          'translate(' + -margin.left + ',' + (heightBarras + 10) + ')'
        )
        .attr('class', 'legend');
      ...
      if ($('.Modal__panel__dona').width() == 0) {
        var widthPrint =
          $('.PrintModal').width() * 0.58 - margin.left - margin.right;
      } else {
        var widthPrint =
          $('.Modal__panel__dona').width() - margin.left - margin.right;
      }
      var y0Print = d3.scale
        .ordinal()
        .rangeRoundBands([heightBarrasPrint, 0], 0.1);

      var y1Print = d3.scale.ordinal();

      var xPrint = d3.scale.linear().range([0, widthPrint]);

      var yAxisPrint = d3.svg
        .axis()
        .scale(y0Print)
        .orient('left')
        .tickFormat(function (d, i) {
      ...
      var xAxisPrint = d3.svg.axis().scale(xPrint).tickSize(0).orient('bottom');
      ...
      y1Print
        ...
        .rangeRoundBands([0, y0Print.rangeBand()]);
      xPrint.domain([0, max]);
      ...
      var slice = svg
        ...
        .attr('class', 'g')
        .attr('transform', function (d) {
          return 'translate(0,' + y0Print(d[0]) + ')';
        });
      ...
      var legend = svg
        ...
        .attr(
          'transform',
          'translate(' + -margin.left + ',' + (heightBarrasPrint + 10) + ')'
        )
        .attr('class', 'legend');
        ...
        for (var j = 0; j < variablesArreglo.length; j++) {
          if (data[i]['CLASE'] == variablesArreglo[j][0]) {
            if (getNivelesFiltro() == '0') {
              ...
              dataArrayPorcentajes[j] += parseFloat(
                getNumber(data[i][variableSeleccion])
              );
      ...
      g.append('text')
        ...
        .text(function (d, i) {
          if (dataArrayPorcentajes[i] > 2) {
            return (
              parseFloat(dataArrayPorcentajes[i].toFixed(1)).toLocaleString(
                'de-DE'
              ) + '%'
            );
          }
      ...
      var legend = svg
        ...
        .attr(
          'transform',
          'translate(' + width / 2 + ',' + radius * 0.8 * 2 + ')'
        )
        .attr('class', 'legend');
      ...
      var legend = svg
        ...
        .attr(
          'transform',
          'translate(' + widthPrint / 2 + ',' + radiusPrint * 0.8 * 2 + ')'
        )
        .attr('class', 'legend');
...
function loadBarsEntidades(data) {
                ...
                if (getNivelesFiltro() == '0') {
                  for (var p = 0; p < variablesArreglo.length; p++) {
                    if (variablesArreglo[p] == variableSeleccion) {
                      arrayDatos[k][1] += parseFloat(
                        getNumber(data[i][variablesArreglo[p]]).replace(
                          ',',
                          '.'
                        )
                      );
                      arrayNumber[k] += parseFloat(
                        getNumber(data[i][variablesArreglo[p]]).replace(
                          ',',
                          '.'
                        )
                  ...
                  for (var p = 0; p < variablesArreglo.length; p++) {
                    if (
                      data[i][variablesFiltroArreglo[p]] == variableSeleccion
                    ) {
                      arrayDatos[k][1] += parseFloat(
                        getNumber(data[i]['VALOR']).replace(',', '.')
                      );
                      arrayNumber[k] += parseFloat(
                        getNumber(data[i]['VALOR']).replace(',', '.')
                      );
  ...
  if ($('.results__panel__participacion').width() == 0) {
    var width =
      $('.Geovisor__content').width() * 0.2 - 20 - margin.left - margin.right;
  } else {
    var width =
      $('.results__panel__participacion').width() - margin.left - margin.right;
  }
  ...
  var svg = d3
    .select('.results__panel__participacion')
    .append('svg')
        ...
        if ($('#FiltroGeograficoLvl1').val() == '-1') {
          if (typeMapDivision == 0) {
            if (feature.getProperty('DPTO_CCDGO') == codigoValor) {
              $var.Map.layers.layerDatos.overrideStyle(feature, {
                strokeColor: 'cyan',
                strokeWeight: 4,
              });
            }
  ...
  if ($('.Modal__panel__participacion').width() == 0) {
    ...
    var widthPrint =
      $('.Modal__panel__participacion').width() - margin.left - margin.right;
  }
  ...
  var svg = d3
    .select('.Modal__panel__participacion')
    .append('svg')
...
function loadBarsH(data) {
    ...
    for (var j = 0; j < variablesArreglo.length; j++) {
      ...
      if (getNivelesFiltro() == '0') {
        if (
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              arrayDatos[j][1] += parseFloat(
                getNumber(data[i][variablesArreglo[j]])
              );
              arrayDatos[j][2] = colores[j];
              arrayNumber[j] += parseFloat(
                getNumber(data[i][variablesArreglo[j]])
              );
            } else {
              if (data[i]['CLASE'] == getClase()) {
  ...
  if ($('.results__panel__graphs').width() == 0) {
    var width =
      $('.Geovisor__content').width() * 0.2 - 10 - margin.left - margin.right;
  } else {
    var width =
      $('.results__panel__graphs').width() - margin.left - margin.right;
  }
  var max = d3.max(arrayNumber) + d3.max(arrayNumber) * 0.1;
  ...
  svg
    ...
    .text(
      'Total: ' +
        totalData.toLocaleString('de-DE') +
        ' ' +
        getUnidades(varVariable)
    ); //
      ...
      if (getNivelesFiltro() == '0') {
        if (
          ...
          if (getTieneClase() == 'S') {
            if (data[i]['CLASE'] == getClase()) {
              arrayDatos[j][1] += parseFloat(
                getNumber(data[i][variablesFiltroArreglo[j]])
              );
              arrayDatos[j][2] = colores[j];
              arrayNumber[j] += parseFloat(
                getNumber(data[i][variablesFiltroArreglo[j]])
...
function loadBarsFrecuencia(data) {
    ...
    if ($('#FiltroGeograficoLvl1').val() == '-1') {
      if (getFID(arrayFID, data.features[i].properties.DPTO_CCDGO)) {
        if (resultadoCortes.length == 1) {
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[0] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[1]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[4];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[1] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[2]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[4];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[2] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[3]
          ) {
            arrayDatos[0][1] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[3] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[4]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[2];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[4] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[5]
          ) {
            arrayDatos[0][1] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[5] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[6]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[0];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[6] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[7]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[0];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[7] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[8]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[0];
            arrayNumber[0] += 1;
          ...
          if (
            data.features[i]['properties']['VARIABLE'] >= resultadoCortes[8] &&
            data.features[i]['properties']['VARIABLE'] <= resultadoCortes[9]
          ) {
            arrayDatos[0][1] += 1;
            arrayDatos[0][2] = color[0];
            arrayNumber[0] += 1;
  ...
  if ($('.results__panel__frequency').width() == 0) {
    ...
    var width =
      $('.results__panel__frequency').width() - margin.left - margin.right;
  }
  var max = d3.max(arrayNumber) + d3.max(arrayNumber) * 0.1;
  var x = d3.scale.linear().domain([0, max]).range([0, width]);
  var y = d3.scale.ordinal().rangeRoundBands([0, height], 0.1);
  ...
  var svg = d3
    .select('.results__panel__frequency')
    .append('svg')
  ...
  if ($('.Modal__panel__frequency').width() == 0) {
    var widthPrint =
      $('.PrintModal').width() * 0.58 - 20 - margin.left - margin.right;
  } else {
    var widthPrint =
      $('.Modal__panel__frequency').width() - margin.left - margin.right;
  }
  var xPrint = d3.scale.linear().domain([0, max]).range([0, widthPrint]);
  ...
  var svg = d3
    .select('.Modal__panel__frequency')
    .append('svg')
...
function loadHistorico(data) {
      ...
      if (getNivelesFiltro() == '0') {
        if (
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              arrayDatos[j][1] += parseFloat(
                getNumber(data[i][variableSeleccionArreglo])
              );
        ...
        if (
          ...
          if (getTieneClase() == 'S') {
            if (getClase() == '0') {
              if (
                data[i][variableSeleccionNombreArreglo] ==
                variableSeleccionArreglo
              ) {
                arrayDatos[j][1] += parseFloat(getNumber(data[i]['VALOR']));
                arrayDatos[j][2] = colores;
                arrayNumber[j] += parseFloat(getNumber(data[i]['VALOR']));
  ...
  if ($('.results__panel__historico').width() == 0) {
    ...
    var width =
      $('.results__panel__historico').width() - margin.left - margin.right;
  }
  var max = d3.max(arrayNumber) + d3.max(arrayNumber) * 0.1;
  ...
  var svg = d3
    .select('.results__panel__historico')
    .append('svg')
  ...
  if ($('.Modal__panel__historico').width() == 0) {
    ...
    var widthPrint =
      $('.Modal__panel__historico').width() - margin.left - margin.right;
  }
  ...
  var svg = d3
    .select('.Modal__panel__historico')
    .append('svg')
...
function loadPiramide(data) {
  ...
  for (var a = 0; a < listaVariables.length; a++) {
    if (varSubtema == listaVariables[a][0].substring(0, 5)) {
      variablesArreglo.push([
        listaVariables[a][1],
        listaFilterVariables[a][1],
        listaNombresVariables[a][1],
      ]);
    }
  }
        ...
        if (getTieneClase() == 'S') {
          if (filtroArea == 0) {
            if (data[i][propiedad] == '1') {
              ...
              dat[j][3] +=
                (parseFloat(getNumber(data[i]['VALOR'])) * 100) / totalHombres;
            }
            if (data[i][propiedad] == '2') {
              dat[j][2] += parseFloat(getNumber(data[i]['VALOR']));
              dat[j][4] +=
                (parseFloat(getNumber(data[i]['VALOR'])) * 100) / totalMujeres;
            }
          } else {
            if (data[i]['CLASE'] == getClase()) {
              if (data[i][propiedad] == '1') {
                dat[j][1] += parseFloat(getNumber(data[i]['VALOR']));
                dat[j][3] +=
                  (parseFloat(getNumber(data[i]['VALOR'])) * 100) /
                  totalHombres;
              }
              if (data[i][propiedad] == '2') {
                dat[j][2] += parseFloat(getNumber(data[i]['VALOR']));
  ...
  var maxValue = d3.max(dat, function (d) {
    if (d[3] > d[4]) return Number(d[3]);
    else return Number(d[4]);
  });
  ...
  var xScale = d3.scale
    ...
    .range([0, regionWidth])
    .nice();
  var xScaleLeft = d3.scale
    .linear()
    .domain([0, maxValue])
    .range([regionWidth, 0]);

  var xScaleRight = d3.scale
    .linear()
    .domain([0, maxValue])
    .range([0, regionWidth]);
  ...
  // BARRA HOMBRES
  var lbg = leftBarGroup.selectAll('.barPir.left').data(dat);
  ...
  // BARRA MUJERES
  var rbg = rightBarGroup.selectAll('.barPir.right').data(dat);
    ...
    div
      ...
      .html(
        'Sexo: ' +
          ...
          '<br>Porcentaje: ' +
          parseFloat(porcentaje.toFixed(1)).toLocaleString('de-DE') +
          '%'
      );
    div
      .style('left', d3.event.pageX - 100 + 'px')
...
function loadTabla(data, inner) {
  ...
  table +=
    "<th data-dynatable-column='cod_departamento'>" +
    'Código Departamento' +
    '</th>';
  table +=
    "<th data-dynatable-column='departamento'>" + 'Departamento' + '</th>';
  if ($('#FiltroGeograficoLvl1').val() != '-1') {
    table +=
      "<th data-dynatable-column='cod_municipio'>" +
      'Código Municipio' +
      '</th>';
  ...
  if (getNivelesFiltro() == '0') {
    for (var h = 0; h < variablesArreglo.length; h++) {
      table +=
        "<th data-dynatable-column='" +
        RemoveAccents(variablesArreglo[h]).replace(/ /g, '').toLowerCase() +
        "'>" +
        variablesNombreArreglo[h] +
        '</th>';
    }
  } else {
    table +=
      "<th data-dynatable-column='" +
      variablesFiltroArreglo[0] +
      "'>" +
      $('.--subtemas-tematicas > .--active.level__2 .--nameSubtema').text() +
      '</th>';
    table +=
      "<th data-dynatable-column='valor'>" + 'Cantidad de Empresas' + '</th>';
  }
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (getNivelesFiltro() == '0') {
      for (var h = 0; h < variablesArreglo.length; h++) {
        if (isFloat(parseFloat(data[i][variablesArreglo[h]]))) {
          tot[
            ...
            parseFloat(data[i][variablesArreglo[h]]).toFixed(1)
          ).toLocaleString('de-DE');
        } else {
          tot[
            RemoveAccents(variablesArreglo[h]).replace(/ /g, '').toLowerCase()
          ] = parseFloat(data[i][variablesArreglo[h]]); //.toLocaleString('de-DE')
        }
        arrayFunctionReader[
          RemoveAccents(variablesArreglo[h]).replace(/ /g, '').toLowerCase()
        ] = function (el, record) {
        ...
        arrayFunctionWriter[
          ...
          return record[this.id]
            ? record[this.id].toLocaleString('de-DE')
            : 'n/a';
        };
      }
    } else {
      if (isFloat(parseFloat(data[i]['VALOR']))) {
        tot['valor'] = parseFloat(
          parseFloat(data[i]['VALOR']).toFixed(1)
        ).toLocaleString('de-DE');
      } else {
        tot['valor'] = parseFloat(data[i]['VALOR']);
      }
      tot[variablesFiltroArreglo[0]] = getNameArreglo(
        data[i][variablesFiltroArreglo[0]]
      );
      ...
      arrayFunctionWriter['valor'] = function (record) {
        return record['valor']
          ? record['valor'].toLocaleString('de-DE')
          : 'n/a';
      };
    }
    if (getTieneAnio() == 'S') {
  ...
  table +=
    '</thead>' + "<tbody class='Geovisor__tableBox__tbody'>" + '</tbody>';
  $('.Geovisor__tableBox__tableContainer').html('');
  $('.Geovisor__tableBox__tableContainer').html(
    "<div class='Geovisor__tableBox__tableContainer__overflow'><table id='tablaDatos' class='Geovisor__tableBox__tableContainer__table'></table></div>"
  );
  ...
  function changeClr() {
    ...
    $('.Geovisor__tableBox__top__actionTable__export__button').on(
      'click',
      function () {
        convertToCSV(
          arrayData,
          $('.level__2.--active .--nameSubtema').text().replaceAll(' ', '_'),
          true
        );
      }
    );
...
$var.Map.loadMarkers = function (infoMarkers) {
  ...
  for (let i = 0; i < infoMarkers.length; i++) {
    ...
    if (empresa.LATITUD != '0') {
      ...
      var contentString =
        '<b><font color="#8C1B48">Información Empresa:</font></b>' +
...
function loadMapa(datum) {
  ...
  if ($('#FiltroGeograficoLvl1').val() == '-1') {
    ...
    var uriAux =
      './src/data/municipios/' + $('#FiltroGeograficoLvl1').val() + '.json';
  }
        ...
        for (var i = 0; i < data.features.length; i++) {
          ...
          if (data.features[i].geometry.type == 'Polygon') {
            ...
            for (
              ...
              for (
                var k = 0;
                k < data.features[i].geometry.coordinates[j].length;
                k++
              ) {
                for (
                  var l = 0;
                  l < data.features[i].geometry.coordinates[j][k].length;
                  l++
                ) {
                  var myLatLng = new google.maps.LatLng(
                    data.features[i].geometry.coordinates[j][k][l][1],
                    data.features[i].geometry.coordinates[j][k][l][0]
                  );
                  bounds.extend(myLatLng);
                }
              }
          ...
          labelsGeografia.push(
            new InfoBox({
              ...
              boxStyle: {
                ...
                fontSize: '0.4rem',
                'text-shadow':
                  'rgb(255, 255, 255) 0px 0px 2px, rgb(255, 255, 255) 0px 0px 4px, rgb(255, 255, 255) 0px 0px 6px',
                width: getAncho(data.features[i].properties.DPTO_CNMBR.length),
              },
              disableAutoPan: true,
              pixelOffset: new google.maps.Size(
                getAnchoOffset(data.features[i].properties.DPTO_CNMBR.length),
                0
              ),
              position: point,
              closeBoxURL: '',
...
function settingMapa(data, datum) {
  if (typeMapDivision == 1) {
    ...
    for (var a = 0; a < data.features.length; a++) {
      listaDivipolaMpios.push([
        data.features[a].properties.MPIO_CCNCT,
        data.features[a].properties.MPIO_CNMBR,
      ]);
    }
  }
  ...
  for (var a = 0; a < listaUnidades.length; a++) {
    if ($var.Map.varVariable == listaUnidades[a][0]) {
      $('.functionAnalysis__slideTrans__textValue__legend').text(
        listaUnidades[a][1]
      );
    }
  }
              ...
              if (getClase() == '0') {
                if (getNivelesFiltro() == '0') {
                  if (getVariableTotal() == 'S') {
                    arrayTotales[i][1] += parseFloat(
                      getNumber(datum[a]['TOTAL_VAR']).replace(',', '.')
                    );
                  } else {
                    if (tipoDiv == 'VAC' || tipoDiv == 'S') {
                      for (var p = 0; p < variablesArreglo.length; p++) {
                        if (variablesArreglo[p] == variableSeleccion) {
                          arrayTotales[i][1] += parseFloat(
                            getNumber(datum[a][variablesArreglo[p]]).replace(
                              ',',
                              '.'
                            )
                          );
                  ...
                  arrayTotales[i][1] += parseFloat(
                    getNumber(datum[a]['VALOR']).replace(',', '.')
                  );
                }
              } else {
        ...
        if (typeMapDivision == 0) {
          if (data.features[i].properties.DPTO_CCDGO == datum[j]['CODIGO_F1']) {
            if (
              tipoDiv == 'VAC' ||
              tipoDiv == 'S' ||
              (tipoDiv == 'C' && variablesArreglo.length == 1)
            ) {
            ...
            if (getNivelesFiltro() == '0') {
              ...
              if (getTieneClase() == 'S') {
                if (getClase() == '0') {
                  if (tipoDiv == 'VA') {
                    data.features[i].properties.VARIABLE = parseFloat(
                      getNumber(datum[j][variableSeleccion]).replace(',', '.')
                    );
                    var county = counties.get(countyCode);
                    county.set(
                      'variable',
                      data.features[i].properties.VARIABLE
                    );
              ...
              if (datum[j][variableFiltro] == variableSeleccion) {
                ...
                if (getTieneClase() == 'S') {
                  if (getClase() == '0') {
                    if (tipoDiv == 'VA') {
                      data.features[i].properties.VARIABLE = parseFloat(
                        getNumber(datum[j]['VALOR']).replace(',', '.')
                      );
                      var county = counties.get(countyCode);
                      county.set(
                        'variable',
                      ...
                      data.features[i].properties.VARIABLE += parseFloat(
                        (100 * getNumber(datum[j]['VALOR']).replace(',', '.')) /
                          sumValores
                      );
                      var county = counties.get(countyCode);
                      county.set(
    ...
    if (data.features[i].properties.VARIABLE != null) {
      ...
      for (
        ...
        if (data.features[i].geometry.coordinates[0][j].length > 2) {
          for (
            var x = 0;
            x < data.features[i].geometry.coordinates[0][j].length;
            x++
          ) {
            myLatLng = new google.maps.LatLng(
              data.features[i].geometry.coordinates[0][j][x][1],
              data.features[i].geometry.coordinates[0][j][x][0]
            );
          }
        } else {
          myLatLng = new google.maps.LatLng(
  ...
  $var.Map.layers3D.layerDatos = new maptalks.VectorLayer('v').addTo(
    $var.Map.map3D
  );
  ...
  for (var i = 0; i < marker.length; i++) {
    if (marker[i].properties.VARIABLE != null) {
          ...
          if (e.target.getProperties().VARIABLE != null) {
            if ($('#FiltroGeograficoLvl1').val() == '-1') {
              if (typeMapDivision == 0) {
                if (tipoDiv == 'VA') {
                  var contentString =
                    "<h4 class='locationPopUp__title'>Información</h4>" +
                    "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>Departamento:</strong> " +
                    e.target.getProperties().DPTO_CCDGO +
                    ' - ' +
                    e.target.getProperties().DPTO_CNMBR +
                    '</p>' +
                    "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>" +
                    getNombreVariable($var.Map.varVariable) +
                    ':</strong> ' +
                    getNumber(e.target.getProperties().VARIABLE).toLocaleString(
                      'de-De'
                    ) +
                    ' ' +
                    getUnidades($var.Map.varVariable) +
                  ...
                  var contentString =
                    ...
                    parseFloat(
                      parseFloat(
                        getNumber(e.target.getProperties().VARIABLE)
                      ).toFixed(1)
                    ).toLocaleString('de-DE') +
                    '% (' +
                    getValorPorcentaje(
                ...
                if (tipoDiv == 'VA') {
                  var contentString =
                    "<h4 class='locationPopUp__title'>Información</h4>" +
                    "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>Municipio:</strong> " +
                    e.target.getProperties().MPIO_CCNCT +
                    ' - ' +
                    e.target.getProperties().MPIO_CNMBR +
                    '</p>' +
                    "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>" +
                    getNombreVariable($var.Map.varVariable) +
                    ':</strong> ' +
            ...
            div.selectAll('text').remove();
            div.append('text').html(contentString);
            div
              .style('left', e.domEvent.clientX + 40 + 'px')
      ...
      marker[i].on('mouseover', function (e) {
        $var.Map.screenCoord =
          'Latitud: ' +
          $var.Map.sixDecimal(e.coordinate.y) +
          ' Longitud: ' +
          $var.Map.sixDecimal(e.coordinate.x);
  ...
  if (
    ...
    $var.Map.layers.layerDatos.forEach(function (feature) {
      if (
        feature.getProperty('MPIO_CCNCT') == $('#FiltroGeograficoLvl2').val()
      ) {
        var bounds = new google.maps.LatLngBounds();
    ...
    function (event) {
      if ($var.Map.clickableLayer) {
        ...
        if (event.feature.getProperty('VARIABLE') != null) {
          if ($('#FiltroGeograficoLvl1').val() == '-1') {
            if (typeMapDivision == 0) {
              if (tipoDiv == 'VA') {
                var contentString =
                  "<h4 class='locationPopUp__title'>Información</h4>" +
                  "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>Departamento:</strong> " +
                  event.feature.getProperty('DPTO_CCDGO') +
                  ' - ' +
                  event.feature.getProperty('DPTO_CNMBR') +
                  '</p>' +
                  "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>" +
                  getNombreVariable($var.Map.varVariable) +
                  ':</strong> ' +
                  getNumber(
                    event.feature.getProperty('VARIABLE')
                  ).toLocaleString('de-De') +
                  ' ' +
                  getUnidades($var.Map.varVariable) +
                  '<br>' +
                ...
                var contentString =
                  ...
                  parseFloat(
                    parseFloat(
                      getNumber(event.feature.getProperty('VARIABLE'))
                    ).toFixed(1)
                  ).toLocaleString('de-DE') +
                  '% (' +
                  getValorPorcentaje(
              ...
              if (tipoDiv == 'VA') {
                var contentString =
                  "<h4 class='locationPopUp__title'>Información</h4>" +
                  "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>Municipio:</strong> " +
                  event.feature.getProperty('MPIO_CCNCT') +
                  ' - ' +
                  event.feature.getProperty('MPIO_CNMBR') +
                  '</p>' +
                  "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>" +
                  getNombreVariable($var.Map.varVariable) +
                  ':</strong> ' +
            ...
            if (tipoDiv == 'VA') {
              var contentString =
                ...
                getNombreVariable($var.Map.varVariable) +
                ':</strong> ' +
                getNumber(event.feature.getProperty('VARIABLE')).toLocaleString(
                  'de-De'
                ) +
                ' ' +
                getUnidades($var.Map.varVariable) +
          ...
          div.append('text').html(contentString);
          div
            .style('left', event.domEvent.pageX + 40 + 'px')
  ...
  google.maps.event.addListener(
    ...
    function (event) {
      $var.Map.screenCoord =
        'Latitud: ' +
        $var.Map.sixDecimal(event.latLng.lat()) +
        ' Longitud: ' +
        $var.Map.sixDecimal(event.latLng.lng());
      $('.map__coord__value').html('');
      $('.map__coord__value').append($var.Map.screenCoord);
  ...
  google.maps.event.addListener(
    ...
    function (event) {
      if (
        $var.Map.clickableLayer &&
        event.feature.getProperty('VARIABLE') != null
      ) {
        $('.loader').addClass('--active');
        if ($('#FiltroGeograficoLvl1').val() == '-1') {
          ...
          $('#place__municipality').text(
            $('#FiltroGeograficoLvl2 :selected').text()
          );
          $('#results__panel__title__site').text(
            $('#FiltroGeograficoLvl1 :selected').text() +
              ' - ' +
              $('#FiltroGeograficoLvl2 :selected').text()
          );
        }
...
function loadPoblacion(data, datosPoblacion) {
  ...
  for (var i = 0; i < data.features.length; i++) {
    ...
    for (var j = 0; j < datosPoblacion.length; j++) {
      if ($('#FiltroGeograficoLvl1').val() == '-1') {
        if (typeMapDivision == 0) {
          if (
            data.features[i].properties.DPTO_CCDGO ==
            datosPoblacion[j]['CODIGO_F1']
          ) {
            dataVariableAltura.set(
              'code',
              data.features[i].properties.DPTO_CCDGO
            );
            var countyCode = data.features[i].properties.FID_ID;
            if (getNivelesFiltro() == '0') {
                ...
                if (getTieneClase() == 'S') {
                  if (getClase() == '0') {
                    if (tipoDiv == 'VA') {
                      aux = parseFloat(
                        getNumber(
                          datosPoblacion[j][variablesArreglo[b]]
                        ).replace(',', '.')
                      );
                    } else if (
                      tipoDiv == 'VC' ||
                  ...
                  if (tipoDiv == 'VA') {
                    aux = parseFloat(
                      getNumber(datosPoblacion[j][variablesArreglo[b]]).replace(
                        ',',
                        '.'
                      )
                    );
              ...
              for (var b = 0; b < variablesCodigoArreglo.length; b++) {
                if (
                  datosPoblacion[j][variablesFiltroArreglo[b]] ==
                  variablesArreglo[b]
                ) {
                  var aux = dataVariableAltura.get(variablesCodigoArreglo[b]);
                  ...
                  if (getTieneClase() == 'S') {
                    if (getClase() == '0') {
                      if (tipoDiv == 'VA') {
                        aux = parseFloat(
                          getNumber(datosPoblacion[j]['VALOR']).replace(
                            ',',
                            '.'
                          )
                        );
          ...
          if (datosPoblacion[j]['CODIGO_F2'].length == 3) {
            codigo_municipio =
              datosPoblacion[j]['CODIGO_F1'] + datosPoblacion[j]['CODIGO_F2'];
          }
          if (data.features[i].properties.MPIO_CCNCT == codigo_municipio) {
            dataVariableAltura.set(
              'code',
              data.features[i].properties.MPIO_CCNCT
            );
            var countyCode = data.features[i].properties.FID_ID;
            if (getNivelesFiltro() == '0') {
              for (var b = 0; b < variablesCodigoArreglo.length; b++) {
  ...
  getExtrusion = d3.scale
    .linear()
    .domain([min_population, max_population])
    .range([0, MAX_EXTRUSION]);
}
...
function loadLeyenda() {
  ...
  color.map(function (obj, j, k) {
    ...
    let square = $('<svg/>', {
      class: 'results__LegendItemSquare',
      style: 'background:' + color[j],
    });
    let text = $('<p/>', {
      class: 'results__LegendItemData',
      text:
        ' ' +
        nombresLeyenda[j].split('-')[0] +
        unidad +
        ' -  ' +
        nombresLeyenda[j].split('-')[1] +
        unidad,
    });
  ...
  $('.results__panel__subtitle__themeName.unidad')
    .empty()
    .text('(' + unidad + ')');
  $('.legendClasi')
    .empty()
    .text(
      'Clasificación de datos: ' +
        $('#functionPalette__classMethod :selected').text()
    );
}
...
function loadLeyendaCirculos(data) {
  ...
  color = [
    chroma(colorPrincipal).set('hsl.l', arrayColores[0]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[1]).hex(),
    chroma(colorPrincipal).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[3]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[4]).hex(),
  ];
...
function loadCirculos(data) {
  ...
  var metersPerPx =
    (156543.03392 *
      Math.cos(($var.Map.map.getCenter().lat() * Math.PI) / 180)) /
    Math.pow(2, $var.Map.map.getZoom());

  var radius = d3.scale
    .linear()
    .domain([min, max])
    .range([5 * metersPerPx, 30 * metersPerPx]);
  ...
  for (var i = 0; i < data.features.length; i++) {
    if (filtroArea == '2') {
      var centro = new google.maps.LatLng(
        data.features[i].properties.Centro_Y,
        data.features[i].properties.Centro_X
      );
      if ($('#FiltroGeograficoLvl1').val() == '-1') {
        var radio = radius(
          parseFloat(
      ...
      if ($('#FiltroGeograficoLvl1').val() == '-1') {
        var centro = new google.maps.LatLng(
          data.features[i].properties.CENTRO_Y_C,
          data.features[i].properties.CENTRO_X_C
        );
        var radio = radius(
          parseFloat(
            getValorPorcentaje(
      ...
      if ($var.Map.clickableLayer) {
        ...
        if (this.variable != null) {
          if ($('#FiltroGeograficoLvl1').val() == '-1') {
            if (tipoDiv == 'VA') {
              var contentString =
                ...
                getNombreVariable($var.Map.varVariable) +
                ':</strong> ' +
                getNumber(this.variable).toLocaleString('de-De') +
                ' ' +
                getUnidades($var.Map.varVariable) +
                '</p>';
            } else if (
              ...
              var contentString =
                ...
                ':</strong> ' +
                parseFloat(
                  parseFloat(getNumber(this.variable)).toFixed(1)
                ).toLocaleString('de-DE') +
                '% (' +
                getValorPorcentaje(
                  getNumber(this.variable),
                  this.codigo
                ).toLocaleString('de-De') +
                ' ' +
                getUnidades($var.Map.varVariable) +
          ...
          div
            .style(
              'left',
              event.domEvent.clientX - $('.tooltip').width() / 2 + 'px'
            )
...
function loadCortes(array) {
  ...
  for (var a = array.length; a < 10; a++) {
    $('#functionPalette__numberMethod [value=' + a + ']').attr(
      'disabled',
      true
    );
  }
  ...
  if (resultadoCortes.length == 1) {
    ...
    nombresLeyenda[0] = parseFloat(
      resultadoCortes[0].toFixed(1)
    ).toLocaleString('de-DE');
  } else if (resultadoCortes.length == 2) {
    max = d3.max(resultadoCortes);
    nombresLeyenda[0] =
      parseFloat(resultadoCortes[0].toFixed(1)).toLocaleString('de-DE') +
      ' - ' +
      parseFloat(resultadoCortes[1].toFixed(1)).toLocaleString('de-DE');
  } else {
    max = d3.max(resultadoCortes);
    for (var a = resultadoCortes.length - 1; a > 0; a--) {
      nombresLeyenda.push(
        parseFloat(resultadoCortes[a - 1].toFixed(1)).toLocaleString('de-DE') +
          ' - ' +
          parseFloat(resultadoCortes[a].toFixed(1)).toLocaleString('de-DE')
      );
    }
  }
}
...
function getColorArray() {
  ...
  if (colorMedium > 1) {
    ...
    scaleUp.domain([0, 4]).range([colorMedium, 0.9]);
  }
  arrayColores = [
    scaleDown(0),
    scaleDown(1),
  ...
  color = [
    chroma(colorPrincipal).set('hsl.l', arrayColores[0]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[1]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[2]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[3]).hex(),
    chroma(colorPrincipal).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[5]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[6]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[7]).hex(),
    chroma(colorPrincipal).set('hsl.l', arrayColores[8]).hex(),
  ];
...
function getMpio(value) {
  for (var a = 0; a < listaDivipolaMpios.length; a++) {
    if (value.length == 3) {
      if (
        $('#FiltroGeograficoLvl1').val() + value ==
        listaDivipolaMpios[a][0]
      ) {
...
function cargarMapaCalor() {
  ...
  $.ajax({
    type: 'GET',
    url:
      'https://geoportal.dane.gov.co/laboratorio/serviciosjson/densidad/puntos.php?anio=2018&x1=' +
      coordX1 +
      '&y1=' +
      coordY1 +
      '&x2=' +
    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.resultado.length; i++) {
        var obj = {
          location: new google.maps.LatLng(
            parseFloat(isNull(data.resultado[i]['LATITUD'])),
            parseFloat(isNull(data.resultado[i]['LONGITUD']))
          ),
      ...
      $('<img src="./src/images/leyenda.png"></img>').appendTo(
        $('.map__legend')
      );
      $('.loader').removeClass('--active');
    },
  ...
  if (metodo == 0) {
    ...
    if ($var.Map.isClosed) {
      ...
      $.ajax({
        type: 'GET',
        url:
          'https://geoportal.dane.gov.co/laboratorio/serviciosjson/variableAltura/indicadordatospoligonos.php?coordendas=' +
          stringCoor,
        crossDomain: true,
        dataType: 'json',
        success: function (data) {
...
function calcularEstadisticas(
  ...
  $.ajax({
    type: 'GET',
    url:
      'https://geoportal.dane.gov.co/laboratorio/serviciosjson/variableAltura/indicadordatosgeoespacial.php?coordx=' +
      coordX +
      '&coordy=' +
      coordY +
      '&longitud=' +
...
function graphUrbano(result) {
  ...
  var start_val = 0;
  var end_val = [
    result[0]['TOTAL_PERSONAS'],
    result[0]['TOTAL_PERSONAS_HOGAR'],
    result[0]['TOTAL_PERSONAS_LEA'],
    result[0]['TOTAL_DE_HOGARES'],
    result[0]['TOTAL_DE_VIVIENDAS'],
  ];
  var names_img = [
    'personas',
    'personashogar',
  ...
  var names_text = [
    'Personas (*)',
    'Total de personas en hogar',
    'Total de personas en LEA',
    'Hogares',
    'Viviendas',
  ];
  ...
  if (
    (result[0]['TOTAL_PERSONAS'] == null || result[0]['TOTAL_PERSONAS'] == 0) &&
    (result[0]['TOTAL_PERSONAS_HOGAR'] == null ||
      result[0]['TOTAL_PERSONAS_HOGAR'] == 0) &&
    (result[0]['TOTAL_PERSONAS_LEA'] == null ||
      result[0]['TOTAL_PERSONAS_LEA'] == 0) &&
    (result[0]['TOTAL_DE_HOGARES'] == null ||
      result[0]['TOTAL_DE_HOGARES'] == 0) &&
    (result[0]['TOTAL_DE_VIVIENDAS'] == null ||
      result[0]['TOTAL_DE_VIVIENDAS'] == 0)
  ) {
    svg
      .append('text')
      .attr('x', width / 2)
    ...
    svg
      ...
      .tween('text', function (d) {
        ...
        return function (t) {
          that.text((Math.round(i(t) * round) / round).toLocaleString('de-DE'));
        };
      });
    ...
    arrayDatos = [
      ['Apartamento', parseInt(result[0]['VIVIENDAS_TIPO_APARTAMENTO'])],
      ['Tipo cuarto', parseInt(result[0]['VIVIENDAS_TIPO_CUARTO'])],
      ['Casa', parseInt(result[0]['VIVIENDAS_TIPO_CASA'])],
      ['Casa Indígena', parseInt(result[0]['VIVIENDAS_TIPO_CASA_INDIGENA'])],
      ['Otro', parseInt(result[0]['VIVIENDAS_OTRO_TIPO_VIENDA'])],
    ];
    arrayNumber = [
      parseInt(result[0]['VIVIENDAS_TIPO_APARTAMENTO']),
      parseInt(result[0]['VIVIENDAS_TIPO_CUARTO']),
      parseInt(result[0]['VIVIENDAS_TIPO_CASA']),
      parseInt(result[0]['VIVIENDAS_TIPO_CASA_INDIGENA']),
      parseInt(result[0]['VIVIENDAS_OTRO_TIPO_VIENDA']),
    ];
    var suma =
      parseInt(result[0]['VIVIENDAS_TIPO_APARTAMENTO']) +
      parseInt(result[0]['VIVIENDAS_TIPO_CUARTO']) +
    ...
    var color = d3.scale
      .ordinal()
      .domain([0, 4])
      .range(['#005499', '#717171', '#dd8800', '#20887c', '#00a1f2']);
    ...
    arrayNumber = [
      parseInt(result[0]['TOTAL_HOMBRES']),
      parseInt(result[0]['TOTAL_MUJERES']),
    ];
    ...
    var suma =
      parseInt(result[0]['TOTAL_HOMBRES']) +
      parseInt(result[0]['TOTAL_MUJERES']);
    var porcentajesNumber = [
      (parseInt(result[0]['TOTAL_HOMBRES']) / suma) * 100,
      (parseInt(result[0]['TOTAL_MUJERES']) / suma) * 100,
    ];
    ...
    polyMen = [
      { x: widthMen * 0.7, y: heightMen * 0.2 },
      { x: widthMen * 0.9, y: heightMen * 0.55 },
      { x: widthMen * 0.8, y: heightMen * 0.55 },
      { x: widthMen * 0.7, y: heightMen * 0.4 },
      { x: widthMen * 0.65, y: heightMen * 0.3 },
      { x: widthMen * 0.65, y: heightMen * 0.4 },
      { x: widthMen * 0.65, y: heightMen * 0.95 },
      { x: widthMen * 0.64, y: heightMen * 1 },
      { x: widthMen * 0.56, y: heightMen * 1 },
      { x: widthMen * 0.53, y: heightMen * 0.95 },
      { x: widthMen * 0.52, y: heightMen * 0.6 },
      //500
      { x: widthMen * 0.48, y: heightMen * 0.6 },
      { x: widthMen * 0.47, y: heightMen * 0.95 },
      { x: widthMen * 0.44, y: heightMen * 1 },
      { x: widthMen * 0.36, y: heightMen * 1 },
      { x: widthMen * 0.35, y: heightMen * 0.95 },
      { x: widthMen * 0.35, y: heightMen * 0.4 },
      { x: widthMen * 0.35, y: heightMen * 0.3 },
      { x: widthMen * 0.3, y: heightMen * 0.4 },
      { x: widthMen * 0.2, y: heightMen * 0.55 },
      { x: widthMen * 0.1, y: heightMen * 0.55 },
      { x: widthMen * 0.3, y: heightMen * 0.2 },
    ];
    ...
    polyWomen = [
      { x: widthWomen * 0.7, y: heightWomen * 0.2 },
      { x: widthWomen * 0.9, y: heightWomen * 0.5 },
      { x: widthWomen * 0.8, y: heightWomen * 0.5 },
      { x: widthWomen * 0.7, y: heightWomen * 0.4 },
      { x: widthWomen * 0.65, y: heightWomen * 0.3 },
      { x: widthWomen * 0.63, y: heightWomen * 0.4 },
      { x: widthWomen * 0.85, y: heightWomen * 0.65 },
      { x: widthWomen * 0.68, y: heightWomen * 0.65 },
      { x: widthWomen * 0.65, y: heightWomen * 0.9 },
      { x: widthWomen * 0.64, y: heightWomen * 1 },
      { x: widthWomen * 0.54, y: heightWomen * 1 },
      { x: widthWomen * 0.53, y: heightWomen * 0.95 },
      { x: widthWomen * 0.53, y: heightWomen * 0.65 },
      //500
      { x: widthWomen * 0.47, y: heightWomen * 0.65 },
      { x: widthWomen * 0.47, y: heightWomen * 0.95 },
      { x: widthWomen * 0.46, y: heightWomen * 1 },
      { x: widthWomen * 0.36, y: heightWomen * 1 },
      { x: widthWomen * 0.35, y: heightWomen * 0.9 },
      { x: widthWomen * 0.32, y: heightWomen * 0.65 },
      { x: widthWomen * 0.15, y: heightWomen * 0.65 },
      { x: widthWomen * 0.37, y: heightWomen * 0.4 },
      { x: widthWomen * 0.35, y: heightWomen * 0.3 },
      { x: widthWomen * 0.3, y: heightWomen * 0.4 },
      { x: widthWomen * 0.2, y: heightWomen * 0.5 },
      { x: widthWomen * 0.1, y: heightWomen * 0.5 },
      { x: widthWomen * 0.3, y: heightWomen * 0.2 },
    ];
    ...
    svg
      ...
      .tween('text', function (d) {
        ...
        return function (t) {
          that.text(
            parseFloat(Math.round(i(t) * round) / round)
              .toFixed(1)
              .toLocaleString('de-DE') + '%'
          );
        };
      ...
      children: [
        {
          ...
          children: [
            {
              name: '0 a 4 años',
              size: parseInt(result[0]['PERSONAS_EDAD_0A4_ANNOS']),
            },
            {
              name: '5 a 9 años',
              size: parseInt(result[0]['PERSONAS_EDAD_5A9_ANNOS']),
            },
            {
              name: '10 a 14 años',
              size: parseInt(result[0]['PERSONAS_EDAD_10A14_ANNOS']),
            },
          ],
        },
        {
          ...
          children: [
            {
              name: '15 a 19 años',
              size: parseInt(result[0]['PERSONAS_EDAD_15A20_ANNOS']),
            },
            {
              name: '20 a 24 años',
              size: parseInt(result[0]['PERSONAS_EDAD_29A24_ANNOS']),
            },
            {
              name: '25 a 29 años',
              size: parseInt(result[0]['PERSONAS_EDAD_25A29_ANNOS']),
            },
            {
              name: '30 a 34 años',
              size: parseInt(result[0]['PERSONAS_EDAD_30A34_ANNOS']),
            },
            {
              name: '35 a 39 años',
              size: parseInt(result[0]['PERSONAS_EDAD_35A39_ANNOS']),
            },
            {
              name: '40 a 44 años',
              size: parseInt(result[0]['PERSONAS_EDAD_40A44_ANNOS']),
            },
            {
              name: '45 a 49 años',
              size: parseInt(result[0]['PERSONAS_EDAD_45A49_ANNOS']),
            },
            {
              name: '50 a 54 años',
              size: parseInt(result[0]['PERSONAS_EDAD_50A54_ANNOS']),
            },
            {
              name: '55 a 59 años',
              size: parseInt(result[0]['PERSONAS_EDAD_55A59_ANNOS']),
            },
          ],
        },
        {
          ...
          children: [
            {
              name: '60 a 64 años',
              size: parseInt(result[0]['PERSONAS_EDAD_60A64_ANNOS']),
            },
            {
              name: '65 a 69 años',
              size: parseInt(result[0]['PERSONAS_EDAD_65A69_ANNOS']),
            },
            {
              name: '70 a 74 años',
              size: parseInt(result[0]['PERSONAS_EDAD_70A74_ANNOS']),
            },
            {
              name: '75 a 79 años',
              size: parseInt(result[0]['PERSONAS_EDAD_75A79_ANNOS']),
            },
            {
              name: '80 ó más años',
              size: parseInt(result[0]['PERSONAS_EDAD_80_O_MAS_ANNOS']),
            },
          ],
        },
        {
          ...
          children: [
            {
              name: 'No informa',
              size: parseInt(result[0]['PERSONAS_EDAD_NO_INFORMA']),
            },
          ],
        },
      ],
...
function loadWMS(urlWMS, nombreCapa) {
  ...
  $(
    '.--uploadLayer .toolBar__container__panel__functionBox__checkList__item__text'
  ).text(nombreCapa);
  var map = $var.Map.map;
  ...
  $(
    '.--uploadLayer .toolBar__container__panel__functionBox__checkList__item__container'
  ).addClass('--active');
}
...
function loadKML() {
  ...
  var filesKML = $(
    '.toolBar__container__panel__functionBox__uploadType__type__upload__selectFile'
  ).prop('files');
  //c(filesKML)
  ...
  $.ajax(settings).done(function (response) {
    maptalks.Formats.kml(
      'https://geoportal.dane.gov.co/upload/' + response.nombre,
      function (err, geojson) {
        // callback when loaded
        $var.Map.layers3D.kmlLayer = new maptalks.VectorLayer(
          'kml',
          geojson
        ).addTo($var.Map.map3D);
      }
    ...
    $var.Map.layers.kmlLayer.setUrl(
      'https://geoportal.dane.gov.co/upload/' + response.nombre
    );

    google.maps.event.addListenerOnce(
      $var.Map.layers.kmlLayer,
      'status_changed',
      function () {
        // console.log('KML status is', $var.Map.layers.kmlLayer.getStatus());
        $(
          '.toolBar__container__panel__functionBox__uploadType__type__seeLayer'
        ).removeClass('--active');
...
function calcularDimensiones() {
  ...
  if (typeMedida == 0) {
    ...
    if (map.getZoom() < 16) {
      ...
      $('.toolBar__container__panel__functionBox__textMeasureValue').text(
        totalMedida
      );
    ...
    if (map.getZoom() < 17) {
      totalMedida =
        (area / (1000 * 1000)).toLocaleString('De-de') +
    ...
    var c1 = new google.maps.LatLng(
      markersMedidas[0].lat(),
      markersMedidas[0].lng()
    );
    var c2 = new google.maps.LatLng(
      markersMedidas[0].lat(),
      markersMedidas[1].lng()
    );
    var c3 = new google.maps.LatLng(
      markersMedidas[1].lat(),
      markersMedidas[1].lng()
    );
    var c4 = new google.maps.LatLng(
      markersMedidas[1].lat(),
      markersMedidas[0].lng()
    );
...
function labelMedida(rutaGeo, map, totalMedida, figura) {
  if (figura == 'linea') {
    if (rutaGeo.length > 1) {
      centro = google.maps.geometry.spherical.interpolate(
        rutaGeo[0],
        rutaGeo[rutaGeo.length - 1],
        0.5
      );
    } else {
      centro = rutaGeo[0];
...
function borrarMedida() {
  ...
  $('.toolBar__container__panel__functionBox__step__btnList__item').removeClass(
    '--active'
  );
...
function loadTopografico() {
  ...
  $var.Map.baseMaps.topografico = new google.maps.ImageMapType(
    TopograficoMapTypeOptions
  );
...
function loadSatelital() {
  var SatelitalMapTypeOptions = {
    getTileUrl: function (coord, zoom) {
      return (
        'http://mt1.google.com/vt/lyrs=s&hl=pl&&x=' +
        coord.x +
        '&y=' +
        coord.y +
        '&z=' +
  ...
  $var.Map.baseMaps.satelital = new google.maps.ImageMapType(
    SatelitalMapTypeOptions
  );
  ...
  $var.Map.base3DMaps.satelital = new maptalks.TileLayer('tile', {
    urlTemplate:
      'https://khms1.googleapis.com/kh?v=845&hl=es-ES&x={x}&y={y}&z={z}',
...
function loadTerreno() {
  ...
  $var.Map.baseMaps.terrain = new google.maps.ImageMapType(
    TerrainMapTypeOptions
  );
...
function printResults() {
  ...
  html2canvas(document.querySelector('.Header__container__logo')).then(
    function (canvas) {
      ...
      html2canvas(
        document.querySelector('.Header__container__textBox__geoportal')
      ).then(function (canvasGeo) {
        ...
        doc.text(
          $('.Header__container__textBox__title').text(),
          xPosTitle,
          yPosTitle
        );
        ...
        doc.setFontSize(10);
        doc.text(
          'Tema: ' + $('.--tema.--active .--nameTema').text().toUpperCase(),
          xPosTema,
          yPosTema,
          'left'
        );
        doc.text(
          'Subtema: ' + $('#results__panel__title__themeName').text(),
          xPosTema,
          yPosTema + 5,
          'left'
        );
        ...
        if (document.querySelector('.map__legend svg')) {
          var str = s.serializeToString(
            document.querySelector('.map__legend svg')
          );
        ...
        html2canvas(document.querySelector('.map'), { useCORS: true }).then(
          function (canvasMap) {
            var ratioCanvasMapPrint = canvasMap.height / canvasMap.width;
            var CanvasMapWidthPrint =
              (canvasMap.width * 206) / $('body').width();
            var CanvasMapHeightPrint =
              CanvasMapWidthPrint * ratioCanvasMapPrint;
            ...
            doc.addImage(
              ...
              yPosMapa,
              CanvasMapWidthPrint,
              CanvasMapHeightPrint
            );

            doc.setFontSize(10);
            doc.text(
              $('.results__panel__source__name').text(),
              206,
              269,
              'right'
            );
            ...
            if (document.querySelector('.Modal__panel__graphs svg')) {
              ...
              var str = s.serializeToString(
                document.querySelector('.Modal__panel__graphs svg')
              );
              canvg(
                document.querySelector('.Modal__panel__graphs_canvas'),
                str
              );
              $('.Modal__panel__graphs_canvas').show();
              $('.Modal__panel__graphs svg').hide();
              var modalGraphImage = document
                .querySelector('.Modal__panel__graphs_canvas')
                .toDataURL('image/png');
              var ratio =
                $('.Modal__panel__graphs_canvas').height() /
                $('.Modal__panel__graphs_canvas').width();
              ...
              doc.addImage(
                ...
                widthPrintGraph,
                heightPrintGraph
              ); //24.07 96.41 5.18346001

              doc.setLineWidth(0.5);
              doc.setDrawColor(0, 0, 0);
              doc.rect(5, 5, 206, 269);
            }
            if (document.querySelector('.Modal__panel__dona svg')) {
              //Puede o no estar
              doc.addPage();
              ...
              doc.text(
                'Tema: ' +
                  $('.--tema.--active .--nameTema').text().toUpperCase(),
                xPosTema,
                yPosTema,
                'left'
              );
              ...
              var str = s.serializeToString(
                document.querySelector('.Modal__panel__dona svg')
              );
              canvg(document.querySelector('.Modal__panel__dona_canvas'), str);
              $('.Modal__panel__dona_canvas').show();
              $('.Modal__panel__dona svg').hide();

              var modalDonaImage = document
                .querySelector('.Modal__panel__dona_canvas')
                .toDataURL('image/png');
              var ratio =
                $('.Modal__panel__dona_canvas').height() /
                $('.Modal__panel__dona_canvas').width();
            ...
            if (document.querySelector('.Modal__panel__participacion svg')) {
              ...
              var str = s.serializeToString(
                document.querySelector('.Modal__panel__participacion svg')
              );
              canvg(
                document.querySelector('.Modal__panel__participacion_canvas'),
                str
              );
              $('.Modal__panel__participacion_canvas').show();
              $('.Modal__panel__participacion svg').hide();

              var modalParticipacionImage = document
                .querySelector('.Modal__panel__participacion_canvas')
                .toDataURL('image/png');
              var ratio =
                $('.Modal__panel__participacion_canvas').height() /
                $('.Modal__panel__participacion_canvas').width();
              var heightPrintParticipacion = widthPrint * ratio;
              doc.addImage(
                modalParticipacionImage,
                'PNG',
                5,
                yPrintParticipacion + 10,
                widthPrint,
                heightPrintParticipacion
              ); //24.07 96.41 5.18346001
              doc.setLineWidth(0.5);
              doc.setDrawColor(0, 0, 0);
              doc.rect(5, 5, 206, 269);
            ...
            if (document.querySelector('.Modal__panel__frequency svg')) {
              ...
              var str = s.serializeToString(
                document.querySelector('.Modal__panel__frequency svg')
              );
              canvg(
                document.querySelector('.Modal__panel__frequency_canvas'),
                str
              );
              $('.Modal__panel__frequency_canvas').show();
              $('.Modal__panel__frequency svg').hide();

              var modalFrecuenciaImage = document
                .querySelector('.Modal__panel__frequency_canvas')
                .toDataURL('image/png');
              var ratio =
                $('.Modal__panel__frequency_canvas').height() /
                $('.Modal__panel__frequency_canvas').width();
              var heightPrintFrecuencia = widthPrint * ratio;
              doc.addImage(
                modalFrecuenciaImage,
                'PNG',
                5,
                yPrintFrecuencia + 10,
                widthPrint,
                heightPrintFrecuencia
              ); //24.07 96.41 5.18346001
              doc.setLineWidth(0.5);
              doc.setDrawColor(0, 0, 0);
              doc.rect(5, 5, 206, 269);
            ...
            if (document.querySelector('.Modal__panel__historico svg')) {
              var yPrintHistorico =
                yPrintFrecuencia + 20 + heightPrintFrecuencia;

              doc.setFontSize(10);
              doc.text('Histórico', 10, yPrintHistorico);

              var str = s.serializeToString(
                document.querySelector('.Modal__panel__historico svg')
              );
              canvg(
                document.querySelector('.Modal__panel__historico_canvas'),
                str
              );
              $('.Modal__panel__historico_canvas').show();
              $('.Modal__panel__historico svg').hide();

              var modalHistoricoImage = document
                .querySelector('.Modal__panel__historico_canvas')
                .toDataURL('image/png');
              var ratio =
                $('.Modal__panel__historico_canvas').height() /
                $('.Modal__panel__historico_canvas').width();
            ...
            doc.save(
              RemoveAccents(
                $('#results__panel__title__themeName')
                  .text()
                  .replaceAll(' ', '_')
              ) +
                '_' +
                RemoveAccents(
                  $('#results__panel__title__site').text().replaceAll(' ', '_')
                ) +
                '.pdf'
            ...
            $('.results').removeClass('--collapse');
            $('.map')
              .removeClass('--collapseRight')
              .removeClass('--collapseLeft');
...
function updateInfoBox() {
  ...
  if ($var.Map.clickableLayer) {
    for (var i = 0; i < intersects.length; i++) {
      ...
      if (countyCode) {
        intersects[i].object.material.materials[1].color = {
        ...
        if (tipoDiv == 'VA') {
          html =
            ...
            getNombreVariable($var.Map.varVariable) +
            ':</strong> ' +
            getNumber(county.get('variable')).toLocaleString('de-De') +
            ' ' +
            getUnidades($var.Map.varVariable) +
            '<br>' +
            '</p>' +
            "<p class='locationPopUp__text'><strong class='locationPopUp__text__bold'>" +
            $('#variable3D :selected').text() +
            ' (Elevación):</strong> ' +
            parseFloat(getNumber(elevation)).toLocaleString('De-de') +
            '</p>';
        } else if (
          tipoDiv == 'VC' ||
          tipoDiv == 'C' ||
          ...
          html =
            ...
            ':</strong> ' +
            parseFloat(
              parseFloat(getNumber(county.get('variable'))).toFixed(1)
            ).toLocaleString('de-DE') +
            '% (' +
            getValorPorcentaje(
              getNumber(county.get('variable')),
              countyCode
            ).toLocaleString('de-De') +
            ' ' +
            getUnidades($var.Map.varVariable) +
        ...
        var reverseY =
          $('#3Dmap').height() * ((-mouse.y + 1) / 2) + $('.Header').height();

        div.selectAll('text').remove();
        div.append('text').html(html);
        div.style('left', reverseX + 40 + 'px').style('top', reverseY + 'px');
        break;
      }
    }
  }
...
function updateMeshes(value) {
  ...
  meshes = counties.entries().map(function (entry) {
    ...
    var mesh = new THREE.Mesh(
      geometry,
      new THREE.MeshFaceMaterial([extrudeMaterial, faceMaterial])
    );
...
function onDocumentMouseMove(event) {
  ...
  mouse.y =
    -(((event.clientY - $('.Header').height()) / $('#3Dmap').height()) * 2) + 1;
}
...
function filtroGeoLvI(idLvl1) {
  ...
  $('.toolBar__container__panel__functionBox__BaseMapList__item').removeClass(
    '--active'
  );
  ...
  $(this)
    .parent()
    .find(
      '.toolBar__container__panel__functionBox__BaseMapList__slideTrans__scrollBtn'
    )
    .css('left', '0px');
  ...
  if ($('#FiltroGeograficoLvl1').val() == '-1') {
    ...
    urlDivipola =
      'https://geoportal.dane.gov.co/laboratorio/serviciosjson/visor_sise/divipola.php' +
      '?codigo_departamento=' +
      idLvl1;
    $.ajax({
      url: urlDivipola,
      ...
      success: function (data) {
        if (data.resultado.length > 0) {
          ...
          $('<option value="-1">Todos los municipios</option>').appendTo(
            $('#FiltroGeograficoLvl2')
          );
          $('#place__department').text(
            $('#FiltroGeograficoLvl1 :selected').text()
          );
          $('#place__municipality').text('Todos los municipios');
          $('#results__panel__title__site').text(
          ...
          for (var i = 0; i < data.resultado.length; i++) {
            $(
              '<option value="' +
                data.resultado[i]['CODIGO_MUNICIPIO'] +
                '">' +
                data.resultado[i]['CODIGO_MUNICIPIO'] +
                ' - ' +
                data.resultado[i]['NOMBRE_MUNICIPIO'] +
                '</option>'
            ).appendTo($('#FiltroGeograficoLvl2'));
            listaDivipolaMpios.push([
              data.resultado[i]['CODIGO_MUNICIPIO'],
              data.resultado[i]['NOMBRE_MUNICIPIO'],
            ]);
...
function filtroGeoLv2(idLvl2) {
  ...
  var manzana = $(
    '.--manzana > div.toolBar__container__panel__functionBox__checkList__item__container'
  );
  $var.Map.dpto.removeClass('--active');
  $var.Map.mpio.removeClass('--active');
  $var.Map.dpto.parent().removeClass('--visible');
  ...
  if ($('#FiltroGeograficoLvl2').val() == '-1') {
    ...
    $(
      '.functionFilter__container__selectListbox__selectList__item.level3'
    ).removeClass('--active');
    $('#BaseMapList__hibrido')
      .find(
        '.toolBar__container__panel__functionBox__BaseMapList__slideTrans__scrollBtn'
      )
      .css('left', '0px');
...
$('#FiltroTotalLvl1').on('change', function () {
  ...
  for (var i = 0; i < totalSubtemas.length; i++) {
    if (
      totalSubtemas[i]['COD_SUBGRUPO'] ==
      $('#FiltroTotalLvl1').val().substring(0, 5)
    ) {
      $(
        '<option value=' +
          totalSubtemas[i]['COD_CATEGORIA'] +
          ' class="function3D__container__switch__content__option">' +
          totalSubtemas[i]['CATEGORIA'] +
          '</option>'
      ).appendTo($('#variable3D'));
    }
  }
...
function load2017() {
  ...
  if (
    $(
      '.toolBar__container__panel__functionBox__checkList__item.--municipio'
    ).hasClass('--visible')
  ) {
  ...
  if (
    $(
      '.toolBar__container__panel__functionBox__checkList__item.--departamento'
    ).hasClass('--visible')
  ) {
...
$('.functionPalette__container__selectListbox__selectList').on(
  'click',
  function () {
    if (
      $(
        '.functionPalette__container__selectListbox__selectList__item.--active'
      ).attr('id') == 'paletteColor__blue'
    ) {
      colorClass = [
        '#08306b',
        '#08519c',
      ...
      $(
        '.functionPalette__container__selectListbox__selectList__item.--active'
      ).attr('id') == 'paletteColor__original'
    ) {
      colorClass = '';
    }
    if ($('#FiltroGeograficoLvl1').val() == '-1') {
...
$('.toolBar__container__panel__functionBox__radioList__item').on(
  'click',
  function () {
...
$('.functionAnalysis__slideTrans__scrollBtn.analysis').on(
  'mousedown',
  function (e) {
    e.stopPropagation();
    movingOpacity = true;
    ...
    function onMouseMove(e) {
      ...
      div
        .style('left', e.clientX - $('.tooltip').width() / 2 + 'px')
...
$('.functionAnalysis__slideTrans__scrollBtn.heatMap').on(
  'mousedown',
  function (e) {
    e.stopPropagation();
    movingOpacity = true;
    ...
    function onMouseMove(e) {
      ...
      div
        .append('text')
        .html(
          Math.round(heatIntensity).toLocaleString('de-De') +
            ' ' +
            $(
              '.functionAnalysis__boxDescription__text__bold .functionAnalysis__slideTrans__textValue__legend'
            ).text()
        );
      div
        .style('left', e.clientX - $('.tooltip').width() / 2 + 'px')
...
$(
  ...
  function onMouseUp() {
    if (
      $(thisBtn)
        .parents('li')
        .find('.toolBar__container__panel__functionBox__BaseMapList__item__btn')
        .attr('id') == 'BaseMapList__gris'
    ) {
      ...
      $(thisBtn)
        .parents('li')
        .find('.toolBar__container__panel__functionBox__BaseMapList__item__btn')
        .attr('id') == 'BaseMapList__topografico'
    ) {
      ...
      $(thisBtn)
        .parents('li')
        .find('.toolBar__container__panel__functionBox__BaseMapList__item__btn')
        .attr('id') == 'BaseMapList__satelital'
    ) {
...
$(
  '.toolBar__container__panel__functionBox__BaseMapList__slideTrans__scrollBar'
).on('mousedown', function (e) {
  e.stopPropagation();
  var thisBtn = $(this).find(
    '.toolBar__container__panel__functionBox__BaseMapList__slideTrans__scrollBtn'
  );
...
$(
  '.toolBar__Container__panel__functionBox__checkList__item__slideTrans__scrollBtn'
).on('mousedown', function (e) {
  e.stopPropagation();
  movingOpacity = true;
  var thisBtn = this;
  ...
  function onMouseUp() {
    if ($(thisBtn).parents('li').hasClass('--ResguardosIndigenas')) {
      ...
      $(thisBtn).parents('li').hasClass('--ConsejosComunitariosNegros')
    ) {
...
$(
  '.toolBar__Container__panel__functionBox__checkList__item__slideTrans__scrollBar'
).on('mousedown', function (e) {
  e.stopPropagation();
  var thisBtn = $(this).find(
    '.toolBar__Container__panel__functionBox__checkList__item__slideTrans__scrollBtn'
...
$('.map__transparency__slideTrans__scrollBar').on('mousedown', function (e) {
  ...
  $var.Map.layers.layerDatos.forEach(function (d) {
    $var.Map.layers.layerDatos.overrideStyle(d, {
      fillOpacity: percentageMapOpacity,
      strokeOpacity: percentageMapOpacity,
    });
  });
...
$('.results__panel__selectGraph__principalList').on('click', function () {
  if ($(this).parent().hasClass('--active')) {
    if ($(this).find('li.--active').attr('id') == 'selectGraphs__bars') {
      ...
      $(this).find('li.--active').attr('id') == 'selectGraphs__bars_v'
    ) {
      loadBarsV(datosGraficos);
      ...
      $(this).find('li.--active').attr('id') == 'selectGraphs__donut'
    ) {
  ...
  $.ajax({
    ...
    success: function (data) {
      $.each(data.resultado, function (key, value) {
        ...
        liTemp
          .addClass(value['CLASE'])
          .attr('id', value['CLASE'])
          .removeClass('--invisible');
        var liDivTemp = liTemp.children(
          '.toolBar__container__panel__functionBox__BaseMapList__item__btn'
        );
        liTemp
          .find(
            '.toolBar__container__panel__functionBox__BaseMapList__item__btn__imageBox__image'
          )
          .attr('title', 'Geoportal DANE - ' + value['NOMBRE'])
          .attr('alt', 'Geoportal DANE - ' + value['NOMBRE'])
          .attr('src', value['IMAGEN_ENLACE']);
        liDivTemp
          .find(
            '.toolBar__container__panel__functionBox__BaseMapList__item__btn__name'
          )
          .text(value['NOMBRE']);
        liTemp.appendTo(ul);
      });
...
$('.toolBar__container__panel__functionBox__BaseMapList__item').on(
  'click',
  function () {
    $('.toolBar__container__panel__functionBox__BaseMapList__item').removeClass(
      '--active'
...
$(
  '#measure__step01 .toolBar__container__panel__functionBox__step__btnList__item__button'
).on('click', function () {
  borrarMedida();
...
$('.toolBar__container__panel__functionBox__uploadType__type__uploadbtn').on(
  'click',
  function () {
...
$('.toolBar__container__panel__functionBox__checkList__item__deleteLayer').on(
  'click',
  function () {
    $(
      '.--uploadLayer .toolBar__container__panel__functionBox__checkList__item__text'
    ).text('Nombre de la capa cargarda');
    $(
      '.toolBar__container__panel__functionBox__uploadType__type__seeLayer'
    ).removeClass('--active');
    $var.Map.map.overlayMapTypes.pop();
    ...
    success: function (data) {
      $.each(data.resultado, function (key, value) {
        ...
        liTemp
          ...
          .removeClass('--invisible');
        var liDivTemp = liTemp.children(
          '.toolBar__container__panel__functionBox__checkList__item__container'
        );
        liTemp
          .find(
            '.toolBar__container__panel__functionBox__checkList__item__source__text'
          )
          .text(value['FUENTE_TEXTO']);
        liTemp
          .find(
            '.toolBar__container__panel__functionBox__checkList__item__source__link'
          )
          .text(value['FUENTE_ENLACE'])
          .attr('href', value['FUENTE_ENLACE']);
        liDivTemp
          .find(
            '.toolBar__container__panel__functionBox__checkList__item__text'
          )
          .text(value['NOMBRE']);
        liTemp.appendTo(ul);
      });
...
function capasReferencia(clase, layer, name, funcion) {
  ...
  var checkSelected =
    '.toolBar__container__panel__functionBox__checkList__item.' + clase + '';
...
//Capas
$('.toolBar__container__panel__functionBox__checkList__item__container').on(
  'click',
  function () {
        ...
        if (status == google.maps.GeocoderStatus.OK) {
          if (results[0]) {
            ...
            setTimeout(function () {
              ...
              if (document.querySelector('.map__legend_2 svg')) {
                var strSimbolos = s.serializeToString(
                  document.querySelector('.map__legend_2 svg')
                );
                canvg(
                  document.getElementById('map__legend__symbol'),
                  strSimbolos
                );
                $('#map__legend__symbol').show();
                $('.map__legend_2 svg').hide();
              ...
              html2canvas(document.querySelector('.map'), {
                ...
                html2canvas(document.querySelector('.printMapInfo'), {
                  useCORS: true,
            ...
            dir =
              'No se ha podido obtener ninguna dirección en esas coordenadas.';
            alert(dir);
          }
        }
      }
...
$(document).ready(function () {
  $('.functionPalette__container__switch__contentSwitch.--type01').click(
    function (e) {
      e.preventDefault();
      $('body').addClass('--blackboard').removeClass('--whiteboard');
      loadNoche();
      $(
        '.functionPalette__container__switch__contentSwitch.--type02'
      ).removeClass('--invisible');
      $(this).addClass('--invisible');
    }
  );
  $('.functionPalette__container__switch__contentSwitch.--type02').click(
    function (e) {
      e.preventDefault();
      $('body').removeClass('--blackboard').addClass('--whiteboard');
      loadGris();
      $(
        '.functionPalette__container__switch__contentSwitch.--type01'
      ).removeClass('--invisible');
      $(this).addClass('--invisible');
    }
  );
  ...
  $var.Map.map.addListener('zoom_changed', function () {
    if (
      filtroArea == '1' ||
      filtroArea == '2' ||
      $('#functionPalette__maptype').val() == '1'
    ) {
      var arrayDatos = [];
      for (var a = 0; a < arrayCirculos.length; a++) {
        if ($('#FiltroGeograficoLvl1').val() == '-1') {
          arrayDatos.push(
            parseFloat(
              getValorPorcentaje(
                arrayCirculos[a].variable,
                arrayCirculos[a].codigo
              )
            )
          );
        } else {
      ...
      var radius = d3.scale
        .linear()
        .domain([min, max])
        .range([10 * metersPerPx, 60 * metersPerPx]);
      loadLeyendaCirculos(datosMapa);

      for (var a = 0; a < arrayCirculos.length; a++) {
        if ($('#FiltroGeograficoLvl1').val() == '-1') {
          arrayCirculos[a].setRadius(
            radius(
              parseFloat(
                getValorPorcentaje(
                  arrayCirculos[a].variable,
